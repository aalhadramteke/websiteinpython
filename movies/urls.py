...
from .views import index, booking, makePayement, occupiedSeats, paymentConfirm, webhook, generate_upi_qr
from .auth_views import register, login_view, logout_view, get_user_info, payment_history, get_payment_history_json, cancel_payment, export_history, clear_all_payments
